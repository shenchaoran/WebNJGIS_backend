...
mongoose.Bluebird = require('bluebird');
const url =
    'mongodb://' +
...
export class Mongoose {
    ...
    public findOne(where): Bluebird<any> {
    ...
    public findByIds(ids: string[]): Bluebird<any> {
    ...
    public find(where): Bluebird<any> {
        return new Bluebird((resolve, reject) => {
    ...
    public remove(where): Bluebird<any> {
        return new Bluebird((resolve, reject) => {
    ...
    public insert(item): Bluebird<any> {
        let queryId
        if (item._id) {
            queryId = item._id;
        }
    ...
    public insertBatch(docs): Bluebird<any> {
        return new Bluebird((resolve, reject) => {
    ...
    public update(where, update, options?): Bluebird<any> {
        return new Bluebird((resolve, reject) => {
    ...
    public upsert(where, update, options?): Bluebird<any> {
        return new Bluebird((resolve, reject) => {
     ...
     *      }
     */
    public findByUserId(userId): Bluebird<any> {
        return Bluebird.all([
            new Bluebird((resolve, reject) => {
                this.model
